...
def setup_environment():
    ...
    # 检查依赖包
    required_packages = ['fastapi', 'uvicorn', 'PIL', 'numpy', 'loguru', 'httpx']
...
def data_processing_demo():
    ...
    # 运行数据处理脚本
    try:
        from data_processor import main as data_main
        data_main()
        print("\n✅ 数据处理能力验证完成！")
...
def model_validation_demo():
    ...
    try:
        from model_validator import run_validation_demo
        run_validation_demo()
        print("\n✅ 模型验证能力验证完成！")
    except Exception as e:
